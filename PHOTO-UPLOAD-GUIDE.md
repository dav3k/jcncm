# How to Add Photos to JCNCM Website
...
4. Verify your email
5. Tell Darius your username so he can give you access to the project

Once Darius adds you, you'll get an email invitation — **click Accept**.
...
In the top right of the page, click the **Add file** button, then click **Upload files**.

### Step 3 — Add your photos

You can either:
- **Drag and drop** photos from your computer into the upload area
